...
3. /expect - показать самые ожидаемые игры
"""
...
BANWORDS_IN_DESCRIPTION = (
    ...
    "недоступна в рф",
    "недоступно в рф",
    "недоступна для россии",
    "недоступна для аккаунтов россии",
    "без активации в рф",
    "не включая рф",
    "не активируется в рф",
    "кроме рф",
    ...
    "оффлайн steam",
    "доступ к счету",
    "невозможно получить на аккаунтах с регионом рф",
    "аренда",
    "недоступно для аккаунтов: Россия",
    "нельзя активировать с российским",
)
...
URL_EXPECTED = """https://vgtimes.ru/games/anticipated/"""
URL_EXPECTED_SHORT = """https://vgtimes.ru"""

RESULT_EXPECTED_SHORT = """
<b>{title}</b>
...
HOW_MANY_GAMES_PRINT = "Сколько игр вывести? Введите число не более 40"

EXAMPLE_SORTED_PRICES = [
    (
        3259,
        (
            "https://plati.market/itm/3901794",
    ...
    (
        5299,
        (
            "https://plati.market/itm/3898632",
    ...
    (
        5690,
        (
            "https://plati.market/itm/3782364",
    ...
    (
        5934,
        (
            "https://plati.market/itm/3782302",
            "STARFIELD STANDARD/PREMIUM STEAM ⚡️АВТО RU+TR+KZ",
        ),
    ),
    (
        6990,
        ("https://plati.market/itm/3782532", "🌌🌟STARFIELD STEAM GIFT🌟🌌 ☑️РФ/МИР☑️"),
    ),
    (
        7990,
        (
            "https://plati.market/itm/3782367",
